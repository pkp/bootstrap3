	...
	<form method="post" id="search-form" class="search-form" action="{url op="search"}" role="search">
		...
		<div class="search-results">
			...
			{iterate from=results item=result}
				{include file="frontend/objects/article_summary.tpl" article=$result.publishedSubmission journal=$result.journal->getPath() showDatePublished=true hideGalleys=true}
			{/iterate}
		</div>
